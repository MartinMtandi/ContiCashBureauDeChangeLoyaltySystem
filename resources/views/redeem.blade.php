...
<div class="app-title">
      ...
      <div class="row">
        ...
        <div class="row">
          <div class="col-md-6">
            <h3 class="tile-title tile heading-background custom-heading" style="margin-bottom: 3px;">Redeem Points<span class="float-right helpme" data-toggle="modal" data-target="#exampleModalCenter"></span></h3>
            <div class="tile-body tile">
              <div class="">
              {!! Form::open(['action' => 'RedeemPointsController@store', 'method' => 'POST', 'class' => 'row']) !!}
                <div class="form-group col-md-7">
                  <label class="" for="exampleInputAmount">Points</label>
          ...
          <div class="col-md-6">
            <h3 class="tile-title text-center tile heading-background custom-heading" style="margin-bottom: 3px;">Points Value</h3>
            <div class="tile-body tile">
              <div class="">
              {!! Form::open(['action' => 'ConvertController@store', 'method' => 'POST', 'class' => 'row']) !!}
                    ...
                    <div class="form-group col-md-7">
                        ...
                        <label>Amount</label>
                        <div class="input-group">
                        <input type="text" class="form-control" placeholder="<?php echo $req_points .' points = $'. number_format((float)$message, 2, '.', ''); ?>" disabled>
                ...
                @foreach($products as $product)
                  <div class="col-sm-3 products text-center">
                    ...
                    {!! Form::open(['action' => 'WalletPaymentController@store', 'method' => 'POST', 'class' => 'wallet-form']) !!}
                      ...
                      <button class="btn btn-block green">Pay Using Wallet</button>
                    {!! Form::close() !!}
                    ...
                    {!! Form::open(['action' => 'WalletPaymentController@store', 'method' => 'POST', 'class' => 'wallet-form']) !!}
                      ...
                      <input type="hidden" name="price" value="{{$product->price}}">
                      <input type="hidden" name="points" value="<?php print convertToPoints($product->price, $product->vas_cos_id, $product->vas_centre_id) ?>">
                      <button class="btn btn-block green" >Pay Using Points</button>
                    {!! Form::close() !!}
                  </div>
                  @endforeach
                @endif
