                ...
                <div class="tile-body">
                    ...
                    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                        <li class="nav-item mr-2">
                            <a class="nav-link active btn btn-news" id="pills-home-tab" data-toggle="pill" href="#pills-home" role="tab" aria-controls="pills-home" aria-selected="true">Newsletter</a>
                        </li>
                        <li class="nav-item mr-2">
                            <a class="nav-link btn btn-channel" id="pills-profile-tab" data-toggle="pill" href="#pills-profile" role="tab" aria-controls="pills-profile" aria-selected="false">Change Channel</a>
                        </li>
                        <li class="nav-item mr-2">
                            <a class="nav-link btn btn-details" id="pills-contact-tab" data-toggle="pill" href="#pills-contact" role="tab" aria-controls="pills-contact" aria-selected="false">Change Contact Details</a>
                        </li>
                    </ul>
                                        ...
                                        @foreach($channels as $channel)
                                            @if($channel->channel_id === 1)
                                                <div class="custom-control custom-checkbox mt-2 mb-2">
                                                    <input type="checkbox" class="custom-control-input green" name="whatsapp" id="customCheck3" <?php if($channel->subscribed == 1) { echo "checked"; } ?>>
                                                    <label class="custom-control-label" for="customCheck3">Whatsapp</label>
                                                </div>
                                            @elseif($channel->channel_id === 2)
                                                <div class="custom-control custom-checkbox mt-2 mb-2">
                                                    <input type="checkbox" class="custom-control-input green" name="email" id="customCheck2" <?php if($channel->subscribed == 1) { echo "checked"; } ?>>
                                                    <label class="custom-control-label" for="customCheck2">Email</label>
                                                </div>
                                            @elseif($channel->channel_id === 3)
                                                <div class="custom-control custom-checkbox mt-2 mb-2">
                                                    <input type="checkbox" class="custom-control-input green" id="customCheck1" <?php if($channel->subscribed == 1) { echo "checked"; } ?> disabled>
                                                    <label class="custom-control-label" for="customCheck1">Dashboard</label>
                                                </div>
                                            @elseif($channel->channel_id === 4)
                                                <div class="custom-control custom-checkbox mt-2 mb-2">
                                                    <input type="checkbox" class="custom-control-input green" name="txt_msg" id="customCheck4" <?php if($channel->subscribed == 1) { echo "checked"; } ?>>
