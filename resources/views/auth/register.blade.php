...
<html>
  <head>
    ...
    <title>Register - Conticash Client-Loyalty System</title>
  </head>
  <body>
      ...
      <div class="login-box" style="min-height: 500px !important;">
        ...
        @csrf
          ...
          <div class="form-group">
            ...
            <input type="tel" class="form-control" id="cell" name="cell" value="{{ old('cell') }}" autocomplete="cell" autofocus>
            <input type="hidden" name="country_code" id="country_code" />
            {{-- <small id="error-cell" class="form-text text-muted">We'll never share your email with anyone else.</small> --}}
          </div>
          <!-----./End input fields----->
          <div class="form-group btn-container">
            <button class="btn btn-block bluebutton" ><i class="fa fa-unlock fa-lg fa-fw"></i>Apply</button>
          </div>
